...
def sax_for_set_bf(X, subsequence_length, word_length, alphabet_size):
    ...
    all_subsequences = []
    for signal in X:
        sax_result, subsequences, breakpoints = sax_bf(
            signal, subsequence_length, word_length, alphabet_size
        )
...
def filtered_sax_for_set_bf(X, subsequence_length, word_length, alphabet_size):
    ...
    sax_results, all_subsequences = sax_for_set_bf(
        X, subsequence_length, word_length, alphabet_size
    )
